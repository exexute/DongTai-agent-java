...
import io.dongtai.utils.FileUtil;
...
public class IastProperties {
    ...
    public void init() throws ClassNotFoundException {
        try {
            ...
            cfg.load(is);
            System.out.println("DongTai Config: " + propertiesFilePath);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public String getLogPath() {
        if (logFilePath == null) {
            String path = System.getProperty("dongtai.log.path", System.getProperty("java.io.tmpdir") + File.separator + "iast");
            if (path.endsWith(File.separator)) {
                logFilePath = path + "dongtai.log";
            } else {
                logFilePath = path + File.separator + "dongtai.log";
            }
    ...
    public String getLogLevel() {
        if (logLevel == null) {
            logLevel = System.getProperty("dongtai.log.level", "info");
        }
        return logLevel;
    }
}
